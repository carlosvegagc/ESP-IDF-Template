...
void lora_task( void* param )
{
	...
	// *** NOT IMPLEMENTED ON THIS APPLICATION ***
	ESP_LOGI(APP_NAME, "STARTS LORA TASK");

	_oled = new OLED( 128, 64, 21, 22, 16 );
	...
	ESP_LOGI(APP_NAME, "Daata sent to screen");
	...
	for ( ;; )
	{
		...
		ESP_LOGI(APP_NAME, "Loop iteration");
